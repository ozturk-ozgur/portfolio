...
function Impressum() {
  return (
    <div>
      <h1 className="my-2">Impressum</h1>
      <h3 className="my-1">Angaben gemäß § 5 TMG</h3>
      <p>Özgür Öztürk</p>
      <p>Ruthenberger markt 22</p>
      ...
      <p className="my-2">
        Impressum vom Impressum Generator der Kanzlei Hasselbach, Rechtsanwälte
        für Arbeitsrecht und Familienrecht.
      </p>
    </div>
  );
}
